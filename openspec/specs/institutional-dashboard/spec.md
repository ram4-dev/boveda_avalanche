...
> Archived provenance: Synced from `openspec/changes/batch-4-institutional-dashboard/specs/institutional-dashboard/spec.md` after `verify-report.md` status PASS during SDD archive phase on 2026-05-16.
